...
- (void)viewDidLoad {
    ...
    for (int i=0; i<arr.count; i++) {
        ...
        if (i==arr.count-1) {
            but=[[UIButton alloc]initWithFrame:CGRectMake(WIDTH-120, 5, 110, ViewHeight-10)];
    ...
    UIButton *loginButton=[[UIButton alloc]initWithFrame:CGRectMake(10, 20+arr.count*ViewHeight+20, WIDTH-10*2, 50)];
