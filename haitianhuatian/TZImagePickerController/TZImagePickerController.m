...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate {
    ...
    if (self) {
        self.maxImagesCount = maxImagesCount > 0 ? maxImagesCount : 100; // / 默认最大可选maxImagesCount张图片
...
//            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:title message:nil delegate:self cancelButtonTitle:@"拒绝" otherButtonTitles:@"允许",nil];
//            [alertView show];
//            
//            
//        } else {
