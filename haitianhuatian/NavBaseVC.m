...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"review"]) {
        self.navigationController.navigationBar.barTintColor=AppBaseColor;
        self.navigationController.navigationBar.tintColor=AppBaseColor;
        UINavigationBar *appearance = [UINavigationBar appearance];
        
        [appearance setBarTintColor:AppBaseColor];
    }
    else{
    self.navigationController.navigationBar.barTintColor=AppBaseColor;
    self.navigationController.navigationBar.tintColor=AppBaseColor;
